...
cs:
	docker-compose -f docker-compose.yml run --rm worm-php /code/vendor/bin/phpcs --standard=/code/phpcs.xml

cs-fix:
	docker-compose -f docker-compose.yml run --rm worm-php /code/vendor/bin/phpcbf --standard=/code/phpcs.xml
