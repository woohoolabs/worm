...
$MYSQL -h worm-mysql -P 3306 -uroot -p$MYSQL_ROOT_PASSWORD -e "${Q1}${Q2}${Q3}"
...
Q4="FLUSH PRIVILEGES;"
$MYSQL -h worm-mysql -P 3306 -uroot -p$MYSQL_ROOT_PASSWORD -e "${Q1}${Q2}${Q3}${Q4}"

# Create schema
$MYSQL -h worm-mysql -P 3306 -u$MYSQL_USER -p$MYSQL_PASSWORD $MYSQL_DATABASE < /code/build/db/db.sql
